        ...
        child: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
                icon: Icon(Icons.sports_soccer), label: 'Data Bola'),
...
class HomePage extends StatelessWidget {
  ...
  final List<Map<String, String>> highlightPemain = [
    {"nama": "Dalberto", "klub": "Arema FC", "foto": "assets/top1.jpeg", "gol": "10 Gol"},
    {"nama": "Maxwell Souza", "klub": "Persija Jakarta", "foto": "assets/top2.jpeg", "gol": "8 Gol"},
    {"nama": "Mariano Peralta", "klub": "Borneo FC", "foto": "assets/top3.webp", "gol": "7 Gol"},
  ];
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // --- Highlight Pemain ---
            Text("🔥 Pemain yang Sedang Bersinar",
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                          ...
                          child: Column(
                            children: [
                              Text(p["nama"]!,
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold)),
                              Text(p["klub"]!, style: const TextStyle(fontSize: 13)),
                              Text(p["gol"]!,
            ...
            // --- Klasemen ---
            Text("🏆 Klasemen Liga 1 Indonesia",
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.green[800])),
                ...
                children: klasemen.map((k) {
                  return ListTile(
                    leading: CircleAvatar(
                      backgroundColor: Colors.green[700],
                      child: Text(k["pos"].toString(),
                          style: const TextStyle(color: Colors.white)),
                    ),
                    title: Text(k["klub"]!,
                        style: const TextStyle(fontWeight: FontWeight.w600)),
                    trailing: Text("${k["poin"]} pts",
...
class DataPage extends StatelessWidget {
  final List<Map<String, String>> jadwal = [
    {"laga": "PSIM vs Persik", "tanggal": "31 Okt 2025", "skor": "2 - 1", "ke": "12"},
    {"laga": "Persija Jakarta vs PSBS Biak", "tanggal": "31 Okt 2025", "skor": "3 - 1", "ke": "12"},
    {"laga": "Bhayangkara FC vs Persita", "tanggal": "1 Nov 2025", "skor": "1 - 1", "ke": "12"},
    {"laga": "Bali United vs Persib Bandung", "tanggal": "1 Nov 2025", "skor": "0 - 1", "ke": "12"},
    {"laga": "PSM Makassar vs Madura United", "tanggal": "2 Nov 2025", "skor": "1 - 1", "ke": "12"},
    {"laga": "Persebaya vs Persis", "tanggal": "2 Nov 2025", "skor": "2 - 1", "ke": "12"},
    {"laga": "Persijap vs Malut United", "tanggal": "3 Nov 2025", "skor": "1 - 2", "ke": "12"},
    {"laga": "Semen Padang vs Arema FC", "tanggal": "3 Nov 2025", "skor": "1 - 2", "ke": "12"},
    {"laga": "Borneo FC vs Dewa United", "tanggal": "5 Nov 2025", "skor": "4 - 0", "ke": "12"},
    {"laga": "PSIM vs Dewa United", "tanggal": "22 Okt 2025", "skor": "2 - 0", "ke": "11"},
    {"laga": "Madura United vs Persija Jakarta", "tanggal": "24 Okt 2025", "skor": "0 - 0", "ke": "11"},
    {"laga": "PSBS Biak vs Persebaya", "tanggal": "24 Okt 2025", "skor": "0 - 0", "ke": "11"},
    {"laga": "Persik vs PSM Makassar", "tanggal": "25 Okt 2025", "skor": "1 - 1", "ke": "11"},
    {"laga": "Bali United vs Persita", "tanggal": "25 Okt 2025", "skor": "0 - 0", "ke": "11"},
    {"laga": "Malut United vs Semen Padang", "tanggal": "26 Okt 2025", "skor": "1 - 0", "ke": "11"},
    {"laga": "Arema FC vs Borneo FC", "tanggal": "26 Okt 2025", "skor": "1 - 3", "ke": "11"},
    {"laga": "Persib Bandung vs Persis", "tanggal": "27 Okt 2025", "skor": "2 - 0", "ke": "11"},
    {"laga": "Bhayangkara FC vs Persijap", "tanggal": "27 Okt 2025", "skor": "2 - 0", "ke": "11"},
  ];
